...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.messageInput.setMaximumSize(QtCore.QSize(16777215, 25))
        self.messageInput.setObjectName("messageInput")
        self.gridLayout.addWidget(self.messageInput, 2, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.nickLabel, 2, 2, 1, 1)
        self.messageDisplay = QtWidgets.QTextEdit(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.messageDisplay.sizePolicy().hasHeightForWidth())
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.nickLabel.setText(_translate("MainWindow", "nick"))
